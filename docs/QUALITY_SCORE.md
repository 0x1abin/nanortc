...
| ICE | `nano_ice.c` | **A** | 20 tests (§7.1.1, §7.2.1, §7.3, §8, §6.1.2.2 pair filter, credentials) | Dual-role FSM, controlled + controlling, pacing, nomination, same-family pair enforcement. IPv4 + IPv6 dual-stack end-to-end (`test_e2e_ipv6_loopback_connects`). Browser + interop verified. |
