...
| [Phase 8: Continued Optimization & Stability](exec-plans/active/phase8-continued-optimization.md) | 8 | **Active** — PR-3 (video pkt_ring decoupling) landed 2026-04-23, PR-5 (ICE CONTROLLING fix) landed 2026-04-13. PR-1/PR-2/PR-4 pending; P2 series on demand. | 4–6 sessions | IoT memory profile, stability propagation, video pkt_ring decoupling, H.264 zero-copy, ICE CONTROLLING per-pair transaction fix |
