...
| [Phase 10: Design Convergence](exec-plans/active/phase10-design-convergence.md) | 10 | **Active** — PR-2 (output lifetime + ESP32-P4 nano hardware bench) landed 2026-04-30; PR-3 (`nanortc_next_timeout_ms()` + run_loop integration) landed 2026-04-29; PR-1 (docs convergence) in flight; PR-4 (RTC orchestration split) pending | 2–3 sessions | Keep authoritative docs current, make output lifetimes explicit, and split RTC orchestration safely |
