...
| [Phase 10: Design Convergence](exec-plans/active/phase10-design-convergence.md) | 10 | **Active** — PR-3 (`nanortc_next_timeout_ms()` + run_loop integration) landed 2026-04-29; PR-1 (docs convergence) and PR-2 (output lifetime) in flight; PR-4 (RTC orchestration split) pending | 2–3 sessions | Keep authoritative docs current, make output lifetimes explicit, and split RTC orchestration safely |
