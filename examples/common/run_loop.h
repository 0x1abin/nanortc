...
/* Non-CMake builds default to explicit local candidates. */
#ifndef NANO_HAVE_GETIFADDRS
 ...
 * Calls nanortc_add_local_candidate() for each. Returns -1 if getifaddrs is
 * unavailable or no usable interface exists; it never invents a candidate. */
